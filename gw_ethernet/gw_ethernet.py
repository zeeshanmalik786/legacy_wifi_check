...
class gw_ethernet:
    ...
    def ethernet(self, run_date):
        ...
        filter(col("polling_date") == (func.date_sub(current_date(), 1))). \
        ...
        hitron_ethernet_hardware = hitron_ethernet_hardware.withColumn("polling_timestamp",
                                                                   date_format(
                                                                       to_timestamp(col("polling_time"), "hh:mm:ss"),
                                                                       'hh:mm:ss')). \
        ...
        # 5
        self.spark.sql("DROP TABLE IF EXISTS business_users_test.tmp_single_modem_ethernet")
        ...
        connection_joined_fiveteen_three_new = self.obj.get_data("business_users_test.tmp_single_modem",["gateway_macaddress",
                                                               "associated_device_macaddress",
                                                               "interface",
                                                               "polling_date",
                                                               "polling_time",
        ...
        output.write.saveAsTable("business_users_test.tmp_single_modem_ethernet")
