...
class unify:
    ...
    def unified_ssid(self, run_date):
        ...
        df_ssid = self.obj.get_data("pma.net_rog_wifi_ssid_fct",["gateway_macaddress",
                                                                 ...
                                                                 "polling_date"])
        # 2
        df_modem_device = self.obj.get_data("business_users_test.tmp_single_modem_ethernet", ["gateway_macaddress",
        ...
        # 5
        self.spark.sql("DROP TABLE IF EXISTS business_users_test.tmp_single_modem_unify_ssid")
        # 6
        combined.select("gateway_macaddress",
            ...
            saveAsTable("business_users_test.tmp_single_modem_unify_ssid")
