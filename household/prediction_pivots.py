...
class prediction_pivots:
    ...
    def prediction_pivot(self):
        self.spark.sql("REFRESH TABLE lwc.tmp_single_modem_intermittancy_percentage")
        data = self.spark.get_data("lwc.tmp_single_modem_intermittancy_percentage", ["gateway_macaddress",
                                                                                          "polling_date",
        ...
        self.spark.sql("DROP TABLE IF EXISTS lwc.tmp_single_modem_prediction_pivots")

        output.write.saveAsTable("lwc.tmp_single_modem_prediction_pivots")
