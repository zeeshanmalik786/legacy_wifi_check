...
class intermittency_percentage:
    ...
    def households(self, run_date):
        ...
        self.spark.sql("REFRESH TABLE business_users_test.tmp_single_modem_additional")
        data = self.obj.get_data("business_users_test.tmp_single_modem_additional", ["gateway_macaddress",
        ...
        accessibility_daily = self.obj.get_data("pma.modem_accessibility_daily", ["mac",
        ...
        self.spark.sql("DROP TABLE IF EXISTS business_users_test.tmp_single_modem_intermittancy_percentage")
        ...
        output.select("gateway_macaddress",
            ...
            drop_duplicates(subset=["gateway_macaddress",
                                    ...
                                    "intermittancy_perc",
                                    "ticket_count"]). \
            write.saveAsTable("business_users_test.tmp_single_modem_intermittancy_percentage")
