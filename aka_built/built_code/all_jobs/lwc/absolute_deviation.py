...
class absolute_deviation:
    ...
    def absolute_deviation(self):
        ...
        data = self.obj.get_data("lwc.tmp_single_modem_device_means", ["gateway_macaddress",
        ...
        self.spark.sql("DROP TABLE IF EXISTS lwc.tmp_single_modem_device_absolute_deviation")
        ...
        mean_join.select("gateway_macaddress",
                         ...
                         "mean_signalstrength",
                         "absdev"
                         ).write.saveAsTable("lwc.tmp_single_modem_device_absolute_deviation")
