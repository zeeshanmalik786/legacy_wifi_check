...
class train_test:
    ...
    def train_test(self):
        ...
        self.spark.sql("REFRESH TABLE lwc.tmp_single_modem_prediction_moving_average")

        data = self.obj.get_data("lwc.tmp_single_modem_prediction_moving_average", ["gateway_macaddress",
                                                                                           "polling_date",
                                                                                           "intermittancy_perc",
                                                                                           "scaled_accessibility_perc_full_day",
                                                                                           "ticket_count",
        ...
        self.spark.sql("DROP TABLE IF EXISTS lwc.tmp_single_modem_prediction_classifier")

        output.write.format("delta").saveAsTable("lwc.tmp_single_modem_prediction_classifier")

        self.spark.sql("REFRESH TABLE lwc.tmp_single_modem_prediction_classifier")

        predictions = self.obj.get_data("lwc.tmp_single_modem_prediction_classifier", ["gateway_macaddress",
                                                                                              "pods_recommendation"])

        self.spark.sql("REFRESH TABLE lwc.tmp_single_modem_recommendation")

        recommendations = self.obj.get_data("lwc.tmp_single_modem_recommendation", ["gateway_macaddress",
        ...
        self.spark.sql("DROP TABLE IF EXISTS lwc.tmp_single_modem_recommendation_predictions")

        pred_recommendation.write.format("delta").saveAsTable("lwc.tmp_single_modem_recommendation_predictions")

        df = self.obj.get_data("lwc.tmp_single_modem_recommendation_predictions", "ALL")

        self.spark.sql("DROP TABLE IF EXISTS lwc.tmp_single_modem_recommendation")

        df.write.saveAsTable("lwc.tmp_single_modem_recommendation")
