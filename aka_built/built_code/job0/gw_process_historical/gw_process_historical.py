from gw_process_historical.preprocess import preprocessor
from pyspark.sql import functions as func
from pyspark.sql.functions import rank, col, max as max_
from pyspark.sql.types import DecimalType
from pyspark.sql.functions import lit, when
from gw_process_historical.config import config
...
class gw_processing:
    ...
    def legacy_wifi_check_gw_aggregations_hist(self, run_date):
        ...
        connected_devices = self.obj.get_data("pma.net_rog_wifi_associated_devices_fct", ["gateway_macaddress",
            ...
            filter((col("polling_date") <= lit(run_date)) & (col("polling_date") >= func.date_sub(lit(run_date), 120)))
        ...
        self.spark.sql("DROP TABLE IF EXISTS lwc.tmp_single_modems_historical_run")
