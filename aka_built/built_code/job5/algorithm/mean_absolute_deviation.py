...
class mean_absolute_deviation():
    ...
    def mean_absolute_deviation(self):
        ...
        data = self.obj.get_data("lwc.tmp_single_modem_device_absolute_deviation", ["gateway_macaddress",
        ...
        self.spark.sql("DROP TABLE IF EXISTS lwc.tmp_single_modem_device_mean_absolute_deviation")
        ...
        output.select("gateway_macaddress",
                      ...
                      "mean_signalstrength",
                      "absdev",
                      "mean_absolute_deviation").write.saveAsTable(
            "lwc.tmp_single_modem_device_mean_absolute_deviation")
        return True