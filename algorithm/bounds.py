...
class bounds:
    ...
    def bounds(self):
        ...
        data = self.obj.get_data("business_users_test.tmp_single_modem_device_mean_absolute_deviation",
                                                                               ["gateway_macaddress",
        ...
        self.spark.sql("DROP TABLE IF EXISTS business_users_test.tmp_single_modem_device_bounder")

        mean_bounds.write.saveAsTable("business_users_test.tmp_single_modem_device_bounder")
